...
<div class="header">
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-4 offset-md-4 form login-form">
                    <form action="center-login.php" method="POST" autocomplete="">
                        <h2 class="text-center" style="color:black;">Recycle Center Login </h2>
                        ...
                        <div class="link login-link text-center" style="color:black;"><b>Not yet a member? </b><a href="center-signup.php"><b>Signup now</b></a></div>
                    </form>
                </div>
            </div>
        </div>
    ...
    <p><a href="../index.html"> <i class="fa fa-home" aria-hidden="true"> Waste Management system</i></a> | <?php echo date('Y'); ?> | 
