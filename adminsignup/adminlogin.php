...
<body>
    ...
    <div class="content flex">
        <p><a href="../index.html"> <i class="fa fa-home" aria-hidden="true"> Waste Management system</i></a> | <?php echo date('Y'); ?> |<a href="../login-user.php"> <i class="fa fa-lock" aria-hidden="true"> Login As User</i></a>
        <a href="../center/center-login.php"> <i class="fa fa-lock" aria-hidden="true"> Login As Recycle Center</i></a>
    </p>
    </div>
    <!--Content ends-->
</body>
